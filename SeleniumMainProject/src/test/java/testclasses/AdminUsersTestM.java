...
public class AdminUsersTestM extends BaseM {
	...
	public void verifyAdminUsersTest() throws IOException {
		 ...
		 * loginPageM.addUserNamePassWord("admin","admin"); loginPageM.clickSignIn();
		 * AdminUsersPageM adminUsersPageM=new AdminUsersPageM(driver);
		 * adminUsersPageM.adminUsersMoreInfoClick();
		 * adminUsersPageM.NewAdminUserclick(); adminUsersPageM.addAdminUserInfor();
		 * adminUsersPageM.UserTypeDropDown(); adminUsersPageM.clickOnSave();
		 */
		LoginPageM loginPageM = new LoginPageM(driver);
		...
		// loginPageM.addUserNamePassWord("admin","admin");//not using hardcoded login
		// details
		...
		adminUsers = adminUsers.NewAdminUserclick().addAdminUserInfor(userNameAd, passwordAd).UserTypeDropDown()
				.clickOnSave();
