...
public class ManageContactUSTestM extends BaseM {
	...
	public void verifyManageContactUs() throws IOException {
		...
		// ManageContactPageM manageContactUs=new ManageContactPageM(driver); here we
		// are not using driver again instead using chaining
		manageContactUs = manageContactUs.manageContactActionBtn().manageContactAddPhone().manageContactAddEmail()
				.manageContactAddAddress().manageContactAddDeliveryTime().manageContactAddDeleiveryCharge()
				.manageContactClickOnUpdate();
