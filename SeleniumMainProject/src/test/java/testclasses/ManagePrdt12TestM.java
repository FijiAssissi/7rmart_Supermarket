...
public class ManagePrdt12TestM extends BaseM {
	...
	public void verifyManageprdt12() throws IOException {
		...
		managePrdt12.managePrdt12NewIconClick().addTitle().selectPrdtType().selectCategory().selectSubCategory()
				.addWeightValue().addWeightUnitdropDown().addMaxQuantity().addPrice().addStockAvailability().addImage()
				.clickOnSaveBtn();
