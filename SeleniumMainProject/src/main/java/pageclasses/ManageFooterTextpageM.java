...
public class ManageFooterTextpageM {
	...
	// @FindBy(xpath
	// ="//a[@href=\"https://groceryapp.uniqassosiates.com/admin/list-footertext\"and
	// @class='small-box-footer']" )WebElement manageFooterMoreInfo;
	...
	/*
	 * public void manageFooterMoreInfoClick() { manageFooterMoreInfo.click();
	 * 
	 * }
	 */
