...
public class HomepageM {
	...
	WebElement managePrdt12MoreInfo;
	...
	// so here actions happen in the Homepage itself and it is not going to any
	// other pages
	{
		admin.click();
		// logout.click();
	...
	public AdminUsersPageM adminUsersMoreInfoClickNew()// here after clicking the admin users moreinfo, it is going to
														// admin pagefor creating NEW admin
	{
	...
	public SearchAdminUsersPageM adminUsersMoreInfoClickSearch()// here after clicking the admin users moreinfo, it is
																// going to admin page for searching admins
	{
		// waitutility.waitForElementToClick(driver, adminMoreInfo);
		adminMoreInfo.click();
