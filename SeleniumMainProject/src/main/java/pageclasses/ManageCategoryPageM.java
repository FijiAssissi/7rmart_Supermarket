...
public class ManageCategoryPageM {
	...
	// and @class='small-box-footer']")WebElement manageCategoryMoreInfo;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement manageCategoryNewIcon;
	@FindBy(xpath = "//input[@id='category']")
	WebElement CategoryName;
	@FindBy(xpath = "//li[@id='134-selectable']")
	WebElement discountClick;
	// @FindBy(xpath = "//input[@id='main_img']") WebElement
	// manageCategoryChooseFileIcon;

	@FindBy(xpath = "//input[@type='file']")
	WebElement manageCategoryChooseFileIcon;
	@FindBy(xpath = "//button[@type='submit']")
	WebElement manageCategorySaveBtn;

	// @FindBy(xpath="//button[@type='submit' and @name='create']") WebElement
	// manageCategorySaveBtn;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement successAlert;

	/*
	 * public void manageCategoryMoreInforClick() { manageCategoryMoreInfo.click();
	 * }
	 * 
	 */
	...
	public ManageCategoryPageM addCategoryName(String categoryName)// here each time we need new category name so we can
																	// use fake data
	{
	 ...
	 * manageCategoryChooseFileIcon.click(); return this; }
	 */
