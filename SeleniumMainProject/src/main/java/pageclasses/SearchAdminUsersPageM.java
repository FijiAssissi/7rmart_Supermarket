...
public class SearchAdminUsersPageM {
	...
	/*
	 * @FindBy(
	 * xpath="//table[@class='table table-bordered table-hover table-sm']/tbody/tr/td[2]"
	...
	public SearchAdminUsersPageM addSearchDetails() {
		...
		pageUtility.selectByVisibleText(UserTypeSearch, "Staff");// instead of using select class , we use page utility
