...
public class ManageNewsPageM {
	...
	// and @class='active nav-link']") WebElement manageNewsMoreInfo;//this is in
	// the home page so written in that class(homepageM)
	// @FindBy(xpath =
	// "//a[@href='https://groceryapp.uniqassosiates.com/admin/news/add']")WebElement
	// manageNewsNewIcon;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement manageNewsNewIcon;
	@FindBy(xpath = "//textarea[@id='news']")
	WebElement addNewsarea;
	@FindBy(xpath = "//button[text()='Save']")
	WebElement saveBtn;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement successAlertNewsInfor;

	/*
	 * //from home page ,after click it is coming to the manageNews page public
	 * ManageNewsPageM manageNewsIcon() { manageNewsMoreInfo.click(); }
	 */
