...
//webelements
	...
	// @FindBy(xpath =
	// "//a[@href='https://groceryapp.uniqassosiates.com/admin/list-contact']")WebElement
	// manageContactMoreInfo;copied this in the homepage class
...
//actions
	/*
	 * it is in the home page so wirtten the code in the homepage class public void
	 * manageContactMoreInfo() { manageContactMoreInfo.click(); }
	 */
