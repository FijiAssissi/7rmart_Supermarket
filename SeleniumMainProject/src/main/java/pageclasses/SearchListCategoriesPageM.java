...
public class SearchListCategoriesPageM {
	...
	WebElement searchIcon_ListCategories;
	@FindBy(xpath = "//input[@placeholder='Category']")
	WebElement addCategoryNameField;
	@FindBy(xpath = "//button[@name='Search']")
	WebElement searchBtn;
	// @FindBy(xpath = "//center[text()='.........RESULT NOT
	// FOUND.......']")WebElement failAlert;
	@FindBy(xpath = "//table[@class='table table-bordered table-hover table-sm']/tbody/tr/td[1]")
	WebElement searchResultBook;
