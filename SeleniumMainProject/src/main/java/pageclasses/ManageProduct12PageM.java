...
public class ManageProduct12PageM {
	...
	// webElements
	// @FindBy(xpath =
	// "//a[@href='https://groceryapp.uniqassosiates.com/admin/list-product' and
	// @class='small-box-footer']")WebElement managePrdt12MoreInfo;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement managePrdt12NewIcon;
	@FindBy(xpath = "//input[@id='title']")
	WebElement addTitleField;
	@FindBy(xpath = "//label[@class='radio-inline'][3]")
	WebElement othersRadioPrdtType;
	@FindBy(xpath = "//select[@id='cat_id']")
	WebElement category;
	@FindBy(xpath = "//select[@id='sub_id']")
	WebElement subcategory;
	// @FindBy(xpath="//select[@id='grp_id']")WebElement groupField;
	@FindBy(xpath = "//label[@class='radio-inline' and @onclick='myFunction_piece()']")
	WebElement priceTypeRadio;
	...
	// actions
	/*
	 * public void managePrdt12MoreInoClick() { managePrdt12MoreInfo.click(); }
	 */
	...
	public ManageProduct12PageM addImage() {
		...
		fileUpload.sendKeysForFileUplad(chooseImage, Constants.BOOKSIMAGEPATH);
		return this;
	}
